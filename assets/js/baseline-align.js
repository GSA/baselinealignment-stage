...
function sidebarOpenClose() {
	$("#site-navBaseline").toggleClass("flyover-sidebar");
	$("#site-navBaseline").toggleClass("d-none");
	$("#site-navBaseline").toggleClass("col");
	$("#site-navBaseline").toggleClass("d-md-block");
	$("#site-navBaseline").toggleClass("col-md-3");
	$("#site-navBaseline").toggleClass("col-xl-2");
	$("#site-navBaseline").toggleClass("fixed-sidebar");
	$("#site-navBaseline").toggleClass("order-0");
